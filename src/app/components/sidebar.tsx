...
export default function Sidebar() {
  ...
  const accountRoleLabel = resolvedRole === 'superadmin'
    ? 'Super Admin'
    : resolvedRole === 'partnership'
      ? 'Partnership Account'
      : (resortLabel || emailLabel || 'Resort Account');
  ...
  return (
    <aside className="hidden w-64 shrink-0 border-r bg-white/90 backdrop-blur md:block ring-1 ring-slate-200">
      <div className="px-5 py-5">
        ...
        <div className="text-xs text-slate-500">{accountRoleLabel}</div>
      </div>
